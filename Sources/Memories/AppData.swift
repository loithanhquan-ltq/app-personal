...
enum Datasets {
  ...
  static let english = Content(
    ...
    places: [
      .init(id: "home",    label: "Our city",      country: "— edit me",        lat: 10.78, lng: 106.70),
      .init(id: "cafe",    label: "The café",      country: "where it began",   lat: 10.79, lng: 106.69),
      .init(id: "dalat",   label: "Đà Lạt",        country: "pines, mist",      lat: 11.94, lng: 108.43),
      .init(id: "hoian",   label: "Hội An",        country: "lanterns",         lat: 15.88, lng: 108.33),
      .init(id: "parents", label: "Your parents'", country: "a small town",     lat: 16.46, lng: 107.59),
      .init(id: "apt",     label: "The apartment", country: "ours",             lat: 10.80, lng: 106.71),
    ],
    memories: enMemories,
    letters: enLetters
  )
  ...
  static let french = Content(
    ...
    places: [
      .init(id: "home",    label: "Notre ville",         country: "— à modifier",           lat: 10.78, lng: 106.70),
      .init(id: "cafe",    label: "Le café",             country: "là où ça a commencé",    lat: 10.79, lng: 106.69),
      .init(id: "dalat",   label: "Đà Lạt",              country: "pins, brume",            lat: 11.94, lng: 108.43),
      .init(id: "hoian",   label: "Hội An",              country: "lanternes",              lat: 15.88, lng: 108.33),
      .init(id: "parents", label: "Chez tes parents",    country: "une petite ville",       lat: 16.46, lng: 107.59),
      .init(id: "apt",     label: "L'appartement",       country: "le nôtre",               lat: 10.80, lng: 106.71),
    ],
    memories: frMemories,
    letters: frLetters
  )
  ...
  static let vietnamese = Content(
    ...
    places: [
      .init(id: "home",    label: "Thành phố của mình", country: "— chỉnh sửa được",     lat: 10.78, lng: 106.70),
      .init(id: "cafe",    label: "Quán cà phê",        country: "nơi tất cả bắt đầu",   lat: 10.79, lng: 106.69),
      .init(id: "dalat",   label: "Đà Lạt",             country: "thông và sương",       lat: 11.94, lng: 108.43),
      .init(id: "hoian",   label: "Hội An",             country: "đèn lồng",             lat: 15.88, lng: 108.33),
      .init(id: "parents", label: "Nhà bố mẹ em",       country: "một thị trấn nhỏ",     lat: 16.46, lng: 107.59),
      .init(id: "apt",     label: "Căn hộ",             country: "của mình",             lat: 10.80, lng: 106.71),
    ],
    memories: viMemories,
    letters: viLetters
  )
